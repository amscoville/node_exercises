...
function genProfile(person) {
	var currAddress = person.address.street + ', ' + person.address.city + ', ' + person.address.state + ', ' + person.address.zip + '.';
	return  person.firstName + ' ' + person.lastName + ': born ' + person.birthYear + ', works at ' + person.work.company + ' since ' + person.work.startYear + ', lives at ' + currAddress;
}
