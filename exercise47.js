...
EXERCISE 47:
		...
		//myEmployee should be {name: 'Sylvester', weight: 175, age:25, isAlive: true, salary: 50000, startYear: 1992, employed: true}

		myEmployee.greet('Ed');
		should return "Hello, Ed, my name is Sylvester!"

		myEmployee.fire();
		//myEmployee should be {name: 'Sylvester', weight: 175, age: 25, isAlive: true, salary: 50000, startYear: 1992, employed: false}
*/
...
class Employee extends Person {
	constructor(name, weight, salary, startYear){
		super(name, weight);
		this.age = 25;
		this.salary = salary; 
